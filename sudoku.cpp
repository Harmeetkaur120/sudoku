...
private:
    ...
    void generate_board(int difficulty) {
        ...
        int numCells;
        switch (difficulty) {
            case 1: numCells = 36; break; // Easy
            case 2: numCells = 27; break; // Medium
            case 3: numCells = 18; break; // Hard
            default: numCells = 36; break; // Default to Easy
        }
...
public:
    ...
    void play() {
        ...
        while (!is_board_full()) {
            ...
            if (cin.fail() || pos.first < 1 || pos.first > 9 || pos.second < 1 || pos.second > 9) {
                cin.clear();
                cin.ignore(numeric_limits<streamsize>::max(), '\n');
                cout << "Invalid position. Please enter values between 1 and 9." << endl;
                continue;
            }
